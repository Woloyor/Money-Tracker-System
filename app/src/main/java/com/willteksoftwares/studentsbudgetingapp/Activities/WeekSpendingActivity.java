...
import com.willteksoftwares.studentsbudgetingapp.Adapters.WeekItemsAdapter;
import com.willteksoftwares.studentsbudgetingapp.Model.Data;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This Month's spending: $"+ totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This week's spending: $"+ totalAmount);
                }
            }
